 ...
 */
public class FuckModelActivity extends AppCompatActivity {
    ...
    public static void start(@NonNull Activity activity, @NonNull String realmFileName) {
        Intent intent = new Intent(activity, FuckModelActivity.class);
    ...
    private void onItemClicked(int position) {
        ...
        FuckBrowserActivity.start(this, position, realmFileName);
    }
}
